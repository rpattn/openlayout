...
export function engineeringDimensions(bounds: Bounds, scale: number, owner: string, settings: CadViewSettings, lane = 0, diameter = false, position: Point = { x: 0, y: 0 }, overrides: Record<string, string> = {}, indexStart = 0, hidden: Record<string, boolean> = {}): string {
