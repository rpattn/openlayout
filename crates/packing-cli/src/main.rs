use packing_core::{
    ...
    solve_prepared, validate_problem,
};
...
fn run() -> Result<Value, String> {
    ...
    match arguments.as_slice() {
        ...
        _ => Err("usage: packing-cli validate <problem.json> | solve <problem.json> [options.json] | sensitivity <problem.json> <study.json>".to_string()),
    }
}
